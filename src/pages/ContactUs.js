...
function ContactUs() {
  ...
  useEffect(() => {
    document.title =
      "Contact InternovaTech - Support, Training Program Help and Certificate Queries";
    ...
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Contact InternovaTech for Training Program support, certificate verification help, account assistance, payment queries and learner guidance."
      );
    }
        ...
        <div className="container contact-v61-shell">
          ...
          <section className="contact-v61-hero">
            ...
            <p className="contact-v61-text">
              Reach out for Training Program access, certificate verification help,
            ...
            <div className="col-lg-5">
              <div className="contact-v61-card">
                ...
                <p className="contact-v61-card-text mb-4">
                  Use the details below for platform support and Training Program-related help.
                </p>
                ...
                <div className="contact-v61-info-box">
                  ...
                  <p className="contact-v61-info-value">
                    Training Program access, account support, certificate queries,
          ...
          <section className="contact-v61-band">
            <div className="contact-v61-band-inner">
              ...
              <p className="contact-v61-band-text">
                ...
                at every stage of their Training Program journey.
              </p>
            </div>
          </section>
        </div>
