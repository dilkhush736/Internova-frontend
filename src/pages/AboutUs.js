...
function AboutUs() {
  ...
  const testimonials = useMemo(
    () => [
      ...
      },
      {
        ...
        text: "The verification support and premium UI gave a lot more trust to the experience. It felt like a proper digital Training Program workspace instead of just another random learning page.",
      },
      {
        name: "Akash Kumar",
        role: "Training Program User",
        text: "I used this website, the platform support and premium UI gave a lot more trust to the experience. It felt like a proper digital Training Program workspace instead of just another random learning page.",
      },
    ],
    []
  );
  ...
  useEffect(() => {
    document.title =
      "InternovaTech - Online Training Program, Verified Certificates and Tech Training";
    ...
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "InternovaTech offers premium online Training Program with practical learning, guided modules, assessments, progress tracking and verified certificates across Web Development, Data Science, Artificial Intelligence, Finance and more."
      );
    }
          ...
          <div className="container home-v67-shell">
              ...
              <div className="row g-4 align-items-center">
                <div className="col-lg-7">
                  ...
                  <h1 className="home-v67-title">
                    ...
                    your premium platform for online Training Program, practical
                  ...
                  <p className="home-v67-subtitle">
                    ...
                    real career-focused skills through structured Training Program
                  ...
                  <div className="home-v67-mini-strip">
                    ...
                    <span className="home-v67-mini-chip">
                      Career-Focused Training Program Paths
                    </span>
                  </div>
                </div>
                      ...
                      <div className="home-v67-metric-grid">
                        <div className="home-v67-metric-card">
                          ...
                          <p className="home-v67-metric-text">
                            Explore role-focused Training Program paths with premium structure.
                          </p>
                        </div>
              ...
              <div className="row g-4">
                <div className="col-md-6">
                  <div className="home-v67-glass-card home-v67-spotlight" onMouseMove={handleSpotlightMove}>
                    ...
                    <p className="home-v67-card-text">
                      Our mission is to make online Training Program and digital
                ...
                <div className="col-md-6">
                  <div className="home-v67-glass-card home-v67-spotlight" onMouseMove={handleSpotlightMove}>
                    ...
                    <p className="home-v67-card-text">
                      ...
                      Training Program participation, progress visibility, assessment
                  ...
                  <div className="home-v67-step-grid">
                    <div className="home-v67-step-card">
                      ...
                      <p className="home-v67-step-text">
                        Discover role-focused Training Program across modern domains.
                      </p>
                    </div>
            ...
            >
              ...
              <p className="home-v67-final-text">
                Whether you want to explore Training Program, continue your
