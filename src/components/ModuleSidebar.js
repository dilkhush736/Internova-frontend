  ...
  return (
    <aside className="course-module-sidebar pro-sidebar-card left-course-sidebar">
      <div className="course-sidebar-top">
        ...
        <p>
          Follow your Training Program roadmap module by module and continue learning
                  ...
                  <div className="pro-module-copy">
                    ...
                    {!module.isUnlocked && (
                      <small className="pro-module-lock-note">
                        Locked until Training Program day {module.unlockDay} or premium
                        unlock activation.
                      </small>
                    )}
                  </div>
                  ...
                  {module.isUnlocked ? (
                    ...
                    <div className="pro-locked-box premium-locked-box">
                      ...
                      <div>
                        ...
                        <p>
                          It becomes available on Training Program day {module.unlockDay}.
